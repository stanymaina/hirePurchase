                        ...
                        <table id="contact-table" class="table table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        {{-- <a class="btn btn-primary" onclick="load_edit_edit()" href="{{route('hire.edit',$hirepurchase->id)}}"><i class="fa fa-pencil"></i>Edit</a> --}}
                                        <a class="btn btn-primary" onclick="load_edit_edit({{$hirepurchase->id}})" data-target="#hire-modal" data-toggle="modal"><i class="fa fa-pencil"></i>Edit</a>
