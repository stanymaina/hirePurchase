...
class ProductsController extends Controller
{
    ...
    public function create()
    {
        ...
        return View::make('product.create', compact('categories'));
    }
    ...
    public function store(Request $request)
    {
        ...
        //     // $Image ->resize(720, 960)->save('../public_html/uploads/images/product_images/' . $filename);
        //     $Image ->resize(700, 400)->save( public_path('/images/' . $filename));
